...
class TestTimeoutRunner:
    ...
    def parse_pytest_output(self, output: str) -> Tuple[int, int, int, List[str], List[str]]:
        """
        ...
        timeout_error_matches = re.findall(timeout_error_pattern, output, re.IGNORECASE | re.DOTALL)
    ...
    def run_iteration(self) -> bool:
        ...
        passed, failed, skipped, timeout_tests, failed_tests = self.parse_pytest_output(output)
    ...
    def run(self) -> bool:
        ...
        print(f"⏱️  Timeout duration: 300 seconds (5 minutes)")
        ...
        while True:
            ...
            if failed > 0:
                ...
                print("   Press Enter to continue after fixing issues (or Ctrl+C to exit)...")
                try:
                    input()
