...
# Test NRCLex to ensure it's working (4.x: load_raw_text; legacy: ctor text)
test_text = 'I am happy'
nrc = NRCLex()
if hasattr(nrc, 'load_raw_text'):
    nrc.load_raw_text(test_text)
else:
