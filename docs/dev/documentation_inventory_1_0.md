...
| docs/runtime/docker-efficiency-baseline.md | Docker efficiency baseline | live | developer | current | RUNTIME headers → GUIDE in 0A pass | retain | — | DEV_INDEX | runtime/docker.md | no |
...
| docs/workflows/index.md | Ten workflow walkthroughs landing | live | user | current | Screenshot guides (**2026-08**); expanded to ten | retain | — | USER_INDEX, index.md | docs/PRODUCT.md | yes |
...
| docs/workflows/charts.md | Workflow 6 — explore Charts | live | user | current | — | retain | — | workflows/index | docs/PRODUCT.md | yes |
| docs/workflows/groups.md | Workflow 7 — bundle into a group | live | user | current | — | retain | — | workflows/index | docs/PRODUCT.md | yes |
...
| website/ | Modest public landing + Pages | live | entry | current | Marketing; Ko-fi live; series **0.9.9.5** | retain | — | README, ROADMAP | PRODUCT.md | no |
