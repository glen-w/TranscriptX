...
| `scripts/audio_merge.py` | Merge split recordings into one MP3 | power user | transcription.md; ROADMAP 1.2 | yes | yes | writes audio | any | ffmpeg | valid | maintainer | retain helper; **1.2** invest (inline audio±transcript merge) vs remove |
