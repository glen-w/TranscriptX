...
| `scripts/eval_speaker_identify_fusion.py` | Auto-identify fusion-table fixtures | maintainer | identify tests | yes | unit | read-only | any | package | valid | maintainer | retain internal |
