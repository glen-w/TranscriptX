> **Archived / superseded.** Historical context only. Current authority: [bertopic_optional_module.md](../../dev/bertopic_optional_module.md). Do not treat as live roadmap or support policy.
