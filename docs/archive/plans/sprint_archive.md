...
The following sprint plan is kept for reference (product backlog history, not “legacy” transcript or API compatibility). Focus is on Phase 1 then Phase 2 as described in [ROADMAP.md](ROADMAP.md). **Sprints 4 and 10 (Longitudinal Speaker Tracking)** are moved to Phase 3 / backlog.
