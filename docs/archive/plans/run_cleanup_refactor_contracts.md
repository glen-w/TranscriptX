> **Archived / superseded.** Historical context only. Current authority: [run_outcome_contract.md](../../run_outcome_contract.md). Do not treat as live roadmap or support policy.
