...
You will have confirmed Local AI readiness, run (or re-run) summary / [**Meeting extracts**](../runtime/llm.md#modules) modules when available, and spot-checked synthesis against the transcript.
