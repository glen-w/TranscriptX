...
- **Longitudinal speaker tracking / Speakers UI** — Phase 1.5–1.6 Speakers UI/analytics and Phase 2 R2 local voice suggested matches shipped; deferred remainder: Stage 9 ANN index, SQLite/DB analytics views, group gallery keyed by `profile_id`.
