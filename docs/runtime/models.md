...
For Docker-specific wiring, see [docker.md](docker.md). For local LLM modules (`llm_summary`, `narrative_summary`), see [llm.md](llm.md). For transcription (upstream of analysis), see [transcription.md](transcription.md).
