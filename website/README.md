...
- Public series badge should match [pyproject.toml](../pyproject.toml) `version` (currently **0.9.9**).
- Install snippet uses `docker compose up transcriptx-web` (same as README).
