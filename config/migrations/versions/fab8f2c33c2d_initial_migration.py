...
def upgrade() -> None:
    ...
    if not _has_index("performance_spans", "idx_span_start_time"):
        op.create_index(
            "idx_span_start_time", "performance_spans", ["start_time"], unique=False
        )

    if not _has_index("speakers", "ix_speakers_first_name"):
        op.create_index(
            op.f("ix_speakers_first_name"), "speakers", ["first_name"], unique=False
        )
    if not _has_index("speakers", "ix_speakers_surname"):
        op.create_index(
            op.f("ix_speakers_surname"), "speakers", ["surname"], unique=False
        )

    _tf_drop = (
        "idx_transcript_content_hash",
        "idx_transcript_schema_version",
        "idx_transcript_sentence_schema_version",
        "idx_transcript_source_hash",
    )
    for idx in _tf_drop:
    ...
    if not _has_index(
        "transcript_segments", "ix_transcript_segments_transcript_speaker_id"
    ):
        op.create_index(
            op.f("ix_transcript_segments_transcript_speaker_id"),
            "transcript_segments",
    ...
    if not _has_fk("transcript_segments", "transcript_speaker_id"):
        with op.batch_alter_table("transcript_segments") as batch:
            batch.create_foreign_key(
                "fk_transcript_segments_transcript_speaker_id",
                "transcript_speakers",
                ["transcript_speaker_id"],
                ["id"],
                ondelete="SET NULL",
    ...
    if not _has_index(
        "transcript_sentences", "ix_transcript_sentences_transcript_speaker_id"
    ):
        op.create_index(
            op.f("ix_transcript_sentences_transcript_speaker_id"),
    ...
    if not _has_fk("transcript_sentences", "transcript_speaker_id"):
        with op.batch_alter_table("transcript_sentences") as batch:
            batch.create_foreign_key(
                "fk_transcript_sentences_transcript_speaker_id",
                "transcript_speakers",
                ["transcript_speaker_id"],
                ["id"],
                ondelete="SET NULL",
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("transcript_sentences") as batch:
        batch.drop_constraint(
            "fk_transcript_sentences_transcript_speaker_id", type_="foreignkey"
        )
    op.drop_index(
        op.f("ix_transcript_sentences_transcript_speaker_id"),
        table_name="transcript_sentences",
    )
    with op.batch_alter_table("transcript_segments") as batch:
        batch.drop_constraint(
            "fk_transcript_segments_transcript_speaker_id", type_="foreignkey"
        )
    op.drop_index(
        op.f("ix_transcript_segments_transcript_speaker_id"),
    ...
    op.drop_index(
        op.f("ix_transcript_files_transcript_content_hash"),
        table_name="transcript_files",
    )
    op.drop_index(
        op.f("ix_transcript_files_source_hash"), table_name="transcript_files"
    )
    op.drop_index(
        op.f("ix_transcript_files_sentence_schema_version"),
        table_name="transcript_files",
    )
    op.drop_index(
        op.f("ix_transcript_files_schema_version"), table_name="transcript_files"
    )
    op.create_index(
        op.f("idx_transcript_source_hash"),
        "transcript_files",
        ["source_hash"],
        unique=False,
    )
    op.create_index(
        op.f("idx_transcript_sentence_schema_version"),
        "transcript_files",
        ["sentence_schema_version"],
        unique=False,
    )
    op.create_index(
        op.f("idx_transcript_schema_version"),
        "transcript_files",
        ["schema_version"],
        unique=False,
    )
    op.create_index(
        op.f("idx_transcript_content_hash"),
        "transcript_files",
    ...
    op.create_index(
        op.f("idx_span_start_time"), "performance_spans", ["start_time"], unique=False
    )
    op.drop_index("idx_span_name_start_time", table_name="performance_spans")
    op.create_index(
        op.f("idx_span_name_start_time"),
        "performance_spans",
        ["name", "start_time"],
        unique=False,
    )
