...
class TestRunResultsSummary:
    ...
    def test_normalizes_modules_skipped_dicts(self):
        ...
        assert s.modules_skipped[0].execution_status == "skipped"
    ...
    def test_modules_skipped_string_entry_raises(self):
        data = {
            "schema_version": 1,
            "run_id": "r1",
            "transcript_key": "k1",
            "modules_enabled": ["stats"],
            "modules_run": [],
            "modules_skipped": ["stats"],
            "modules_failed": [],
            "errors": [],
        }
        with pytest.raises(ValueError, match="modules_skipped entries must be dicts"):
...
class TestValidateManifestShape:
    ...
    def test_missing_manifest_type_raises(self):
        manifest = {
            "run_id": "r1",
            "run_metadata": {
                "timestamp": "2026-01-01T00:00:00",
