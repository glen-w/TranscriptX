...
from transcriptx.core.config import load_project_config, resolve_effective_config, save_project_config
...
def test_cli_config_round_trip_into_web_config(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        config_persistence, "CONFIG_DRAFTS_DIR", config_persistence.CONFIG_DIR / "drafts"
    )
