...
from transcriptx.cli.transcription_workflow import _run_transcription_workflow_impl, _run_post_transcription_analysis
...
class TestAudioToAnalysisWorkflow:
    ...
    def test_complete_happy_path(
        ...
        with patch('transcriptx.cli.transcription_workflow.select_audio_for_whisperx_transcription') as mock_select, \
             patch('transcriptx.cli.transcription_workflow.transcribe_with_whisperx') as mock_transcribe, \
             patch('transcriptx.cli.transcription_workflow.questionary.confirm') as mock_confirm, \
             patch('transcriptx.cli.transcription_workflow.select_analysis_mode') as mock_mode, \
             patch('transcriptx.cli.transcription_workflow.apply_analysis_mode_settings') as mock_apply, \
             patch('transcriptx.cli.transcription_workflow.get_available_modules') as mock_modules, \
             patch('transcriptx.cli.transcription_workflow.run_analysis_pipeline') as mock_pipeline:
    ...
    def test_post_transcription_analysis_flow(
        ...
        with patch('transcriptx.cli.transcription_workflow.select_analysis_mode') as mock_mode, \
             patch('transcriptx.cli.transcription_workflow.apply_analysis_mode_settings') as mock_apply, \
             patch('transcriptx.cli.transcription_workflow.questionary.confirm') as mock_confirm, \
             patch('transcriptx.cli.transcription_workflow.get_available_modules') as mock_modules, \
             patch('transcriptx.cli.transcription_workflow.run_analysis_pipeline') as mock_pipeline:
    ...
    def test_service_management_integration(self, sample_audio_file, tmp_path):
        ...
        with patch('transcriptx.cli.transcription_workflow.select_audio_for_whisperx_transcription') as mock_select, \
             patch('transcriptx.cli.transcription_workflow.check_whisperx_compose_service') as mock_check, \
             patch('transcriptx.cli.transcription_workflow.start_whisperx_compose_service') as mock_start, \
             patch('transcriptx.cli.transcription_workflow.wait_for_whisperx_service') as mock_wait, \
             patch('transcriptx.cli.transcription_workflow.transcribe_with_whisperx') as mock_transcribe:
    ...
    def test_state_persistence(self, sample_audio_file, sample_transcript_file, tmp_path):
        """Test state persistence across workflow steps."""
        with patch('transcriptx.cli.transcription_workflow.select_audio_for_whisperx_transcription') as mock_select, \
             patch('transcriptx.cli.transcription_workflow.transcribe_with_whisperx') as mock_transcribe, \
             patch('transcriptx.cli.processing_state.save_processing_state') as mock_save_state, \
             patch('transcriptx.cli.transcription_workflow.questionary.confirm') as mock_confirm:
    ...
    def test_output_directory_structure(self, sample_audio_file, sample_transcript_file, tmp_path):
