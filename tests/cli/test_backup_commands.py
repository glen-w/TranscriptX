...
class TestListStateBackups:
    ...
    def test_displays_backups_table(self, tmp_path, monkeypatch):
        ...
        with patch('transcriptx.cli.backup_commands.list_backups') as mock_list, \
...
class TestRestoreStateBackup:
    ...
    def test_restores_selected_backup(self, tmp_path):
        ...
        with patch('transcriptx.cli.backup_commands.list_backups') as mock_list, \
             ...
             patch('transcriptx.cli.backup_commands.restore_from_backup') as mock_restore, \
             patch('transcriptx.cli.backup_commands.console') as mock_console:
            ...
            mock_q.select.return_value.ask.return_value = f"{backup_file.name} (2025-01-01T12:00:00)"
    ...
    def test_cancels_when_user_cancels_selection(self):
        ...
        with patch('transcriptx.cli.backup_commands.list_backups') as mock_list, \
            ...
            mock_list.return_value = [
                {"name": "backup.json.backup", "path": "/path/to/backup", "created": "2025-01-01"}
            ]
    ...
    def test_cancels_when_user_cancels_confirmation(self, tmp_path):
        ...
        with patch('transcriptx.cli.backup_commands.list_backups') as mock_list, \
            ...
            mock_list.return_value = [
                {"name": backup_file.name, "path": str(backup_file), "created": "2025-01-01"}
            ]
            mock_q.select.return_value.ask.return_value = f"{backup_file.name} (2025-01-01)"
...
class TestCreateManualBackup:
    ...
    def test_creates_backup_successfully(self, tmp_path):
        ...
        with patch('transcriptx.cli.backup_commands.create_backup') as mock_create, \
             patch('transcriptx.cli.backup_commands.console') as mock_console:
