...
class TestLoadProcessingState:
    ...
    def test_load_processing_state_existing(self, tmp_path):
        ...
        with patch('transcriptx.cli.processing_state.PROCESSING_STATE_FILE', state_file):
...
class TestMarkFileProcessed:
    ...
    def test_mark_file_processed(
        self, mock_save, mock_load, tmp_path
    ):
        ...
        mark_file_processed(wav_file, {"transcript_path": str(tmp_path / "transcript.json")})
...
class TestGetCurrentTranscriptPathFromState:
    ...
    def test_get_current_transcript_path_found(self, tmp_path):
        ...
        with patch('transcriptx.cli.processing_state.load_processing_state', return_value=state):
