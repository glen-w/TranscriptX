...
class TestTranscribeWithWhisperx:
    ...
    def test_transcribes_audio_file(self, tmp_path):
        ...
        with patch('transcriptx.cli.transcription_common.check_whisperx_compose_service') as mock_check, \
             patch('transcriptx.cli.transcription_common.run_whisperx_compose') as mock_transcribe, \
             patch('transcriptx.cli.transcription_common.wait_for_whisperx_service') as mock_wait:
    ...
    def test_starts_service_when_not_running(self, tmp_path):
        ...
        with patch('transcriptx.cli.transcription_common.check_whisperx_compose_service') as mock_check, \
             patch('transcriptx.cli.transcription_common.start_whisperx_compose_service') as mock_start, \
             patch('transcriptx.cli.transcription_common.wait_for_whisperx_service') as mock_wait, \
             patch('transcriptx.cli.transcription_common.run_whisperx_compose') as mock_transcribe:
