...
class TestLoadTagsForTranscript:
    ...
    def test_resolves_transcript_path(self, tmp_path):
        ...
        with (
            ...
            load_tags_for_transcript(transcript_path)
...
class TestOfferAndEditTags:
    ...
    def test_offers_tag_editing(self, tmp_path):
        ...
        with (
            patch("transcriptx.cli.tag_workflow.load_tags_for_transcript") as mock_load,
            patch(
                "transcriptx.cli.tag_workflow.manage_tags_interactive"
            ) as mock_manage,
    ...
    def test_skips_prompt_in_batch_mode(self, tmp_path):
        ...
        with patch(
            "transcriptx.cli.tag_workflow.load_tags_for_transcript"
        ) as mock_load:
            mock_load.return_value = {
                "auto_tags": ["meeting"],
                "current_tags": ["meeting"],
...
class TestSaveTagsToState:
    ...
    def test_saves_tags_to_state(self, tmp_path):
        ...
        state_data = {
            "processed_files": {"test.wav": {"transcript_path": transcript_path}}
        }
    ...
    def test_updates_existing_entry(self, tmp_path):
        ...
        state_data = {
            "processed_files": {
                "test.wav": {"transcript_path": transcript_path, "tags": ["old_tag"]}
            }
        }
