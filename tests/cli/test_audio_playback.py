...
class TestSegmentPlayer:
    ...
    def test_stop_before_play(self, tmp_path):
        ...
        with (
            patch("transcriptx.cli.audio.playback.stop_audio_playback") as mock_stop,
            patch(
    ...
    def test_ffplay_args_include_noise_flags(self, tmp_path):
        ...
        with (
            ...
            patch("transcriptx.cli.audio.playback.subprocess.Popen") as mock_popen,
        ):
    ...
    def test_afplay_failure_falls_back_to_temp_clip(self, tmp_path, monkeypatch):
        ...
        player = SegmentPlayer()
        monkeypatch.setattr("transcriptx.cli.audio.playback.sys.platform", "darwin")
