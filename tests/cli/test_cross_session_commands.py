...
]  # reason: tests CrossSessionTrackingService/get_session which were removed/renamed; owner: cli; remove_by: when cross_session API stabilizes
...
class TestCrossSessionCommands:
    ...
    def test_cross_session_match_speakers_command(
        ...
        with (
            ...
            patch(
                "transcriptx.cli.cross_session_commands.CrossSessionTrackingService"
    ...
    def test_cross_session_list_clusters_command(
        ...
        with patch(
            "transcriptx.cli.cross_session_commands.get_session",
    ...
    def test_cross_session_analyze_patterns_command(
        self, typer_test_client, mock_database
    ):
        """Test cross-session analyze-patterns command."""
        result = typer_test_client.invoke(
            app, ["cross-session", "analyze-patterns", "--help"]
        )
