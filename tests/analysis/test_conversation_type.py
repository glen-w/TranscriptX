...
class TestConversationTypeDetector:
    ...
    def sample_segments_meeting(self):
        """Fixture for sample meeting transcript segments using segment-based speaker identification."""
        return [
            {
                "speaker": "Alice",
                "speaker_db_id": 1,
    ...
    def sample_segments_conversation(self):
        """Fixture for sample conversation transcript segments using segment-based speaker identification."""
        return [
            {
                "speaker": "Alice",
                "speaker_db_id": 1,
    ...
    def sample_segments_voice_note(self):
        """Fixture for sample voice note transcript segments using segment-based speaker identification."""
        return [
            {
                "speaker": "Alice",
                "speaker_db_id": 1,
