...
class TestConversationTypeDetector:
    ...
    def sample_segments_meeting(self):
        ...
        return [
            {"speaker": "Alice", "speaker_db_id": 1, "text": "Let's start the meeting. First item on the agenda.", "start": 0.0, "end": 2.0},
            {"speaker": "Bob", "speaker_db_id": 2, "text": "I'll present the status update.", "start": 2.0, "end": 4.0},
            {"speaker": "Charlie", "speaker_db_id": 3, "text": "Great, let's review the action items.", "start": 4.0, "end": 6.0},
        ]
    ...
    def sample_segments_conversation(self):
        ...
        return [
            {"speaker": "Alice", "speaker_db_id": 1, "text": "Hey, how are you?", "start": 0.0, "end": 2.0},
    ...
    def sample_segments_voice_note(self):
        ...
        return [
            {"speaker": "Alice", "speaker_db_id": 1, "text": "Let me think about this. I'm reflecting on the project.", "start": 0.0, "end": 2.0},
            {"speaker": "Alice", "speaker_db_id": 1, "text": "This is a personal note to myself.", "start": 2.0, "end": 4.0},
        ]
