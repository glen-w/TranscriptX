...
class TestTicsAnalysis:
    ...
    def sample_segments(self) -> list[dict[str, Any]]:
        """Fixture for sample transcript segments with tics using segment-based speaker identification."""
        return [
            {
                "speaker": "Alice",
                "speaker_db_id": 1,
    ...
    def test_tics_analysis_basic(
        ...
        result = tics_module.analyze(sample_segments)
    ...
    def test_tics_detection(
        ...
        result = tics_module.analyze(segments)
