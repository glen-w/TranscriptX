...
class TestInteractionAnalysisModule:
    ...
    def sample_segments(self):
        ...
        return [
            ...
            {"speaker": "Alice", "speaker_db_id": 1, "text": "How are you?", "start": 2.0, "end": 3.0},
            {"speaker": "Bob", "speaker_db_id": 2, "text": "I'm good, thanks", "start": 3.0, "end": 4.0}
        ]
    ...
    def test_interactions_analysis_basic(self, interactions_module, sample_segments, sample_speaker_map):
    ...
    def test_interactions_analysis_turn_taking(self, interactions_module, sample_segments, sample_speaker_map):
    ...
    def test_interactions_analysis_response_time(self, interactions_module, sample_segments, sample_speaker_map):
    ...
    def test_interactions_analysis_overlap(self, interactions_module, sample_segments, sample_speaker_map):
        """Test overlap detection."""
        # Create segments with potential overlap
        overlapping_segments = [
            {"speaker": "Alice", "speaker_db_id": 1, "text": "Hello", "start": 0.0, "end": 2.0},
            {"speaker": "Bob", "speaker_db_id": 2, "text": "Hi", "start": 1.0, "end": 2.0}  # Overlaps
        ]
    ...
    def test_interactions_analysis_empty_segments(self, interactions_module, sample_speaker_map):
