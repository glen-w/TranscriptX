...
class TestInteractionAnalysisModule:
    ...
    def sample_segments(self):
        """Fixture for sample transcript segments with interactions and segment-based speaker identification."""
        return [
            {
                "speaker": "Alice",
                "speaker_db_id": 1,
    ...
    def test_interactions_analysis_basic(
        ...
        result = interactions_module.analyze(sample_segments)
    ...
    def test_interactions_analysis_overlap(
        ...
        result = interactions_module.analyze(overlapping_segments)
    ...
    def test_interactions_analysis_empty_segments(
        ...
        result = interactions_module.analyze(segments)
