...
def test_highlights_markdown_empty_themes_omits_key_themes_section() -> None:
    """Explicit themes=[] skips derived theme block (legacy-style payloads)."""
    highlights = {
        "themes": [],
        "sections": {
            "cold_open": {
    ...
    md = render_highlights_markdown(highlights)
