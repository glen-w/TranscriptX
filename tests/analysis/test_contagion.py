...
class TestContagionAnalysis:
    ...
    def sample_segments_with_emotion(self):
        """Fixture for sample transcript segments with emotion data using segment-based speaker identification."""
        return [
            {
                "speaker": "Alice",
                "speaker_db_id": 1,
    ...
    def sample_segments_no_emotion(self):
        """Fixture for sample transcript segments without emotion data using segment-based speaker identification."""
        return [
            {
                "speaker": "Alice",
                "speaker_db_id": 1,
    ...
    def test_contagion_analysis_with_emotion_data(
        ...
        result = contagion_module.analyze(sample_segments_with_emotion)
    ...
    def test_contagion_analysis_no_emotion_data(
        ...
        with pytest.raises(ValueError, match="No emotion data found"):
            contagion_module.analyze(sample_segments_no_emotion)
    ...
    def test_contagion_analysis_with_emotion_parameter(
        ...
        result = contagion_module.analyze(
            sample_segments_no_emotion, emotion_data=emotion_data
        )
    ...
    def test_contagion_analysis_empty_segments(
        ...
        with pytest.raises(ValueError, match="No emotion data found"):
            contagion_module.analyze(segments)
