...
class TestContagionAnalysis:
    ...
    def sample_segments_no_emotion(self):
        ...
        return [
            {"speaker": "Alice", "speaker_db_id": 1, "text": "Hello there.", "start": 0.0, "end": 2.0},
            {"speaker": "Bob", "speaker_db_id": 2, "text": "Hi!", "start": 2.0, "end": 4.0},
        ]
    ...
    def test_contagion_analysis_with_emotion_data(self, contagion_module, sample_segments_with_emotion, sample_speaker_map):
        """Test contagion analysis with emotion data in segments."""
        result = contagion_module.analyze(sample_segments_with_emotion, sample_speaker_map)
        
        assert "contagion_events" in result or "contagion_analysis" in result or "summary" in result
        assert "segments" in result or "timeline" in result
    
    def test_contagion_analysis_no_emotion_data(self, contagion_module, sample_segments_no_emotion, sample_speaker_map):
    ...
    def test_contagion_analysis_with_emotion_parameter(self, contagion_module, sample_segments_no_emotion, sample_speaker_map):
        ...
        result = contagion_module.analyze(sample_segments_no_emotion, sample_speaker_map, emotion_data=emotion_data)
    ...
    def test_contagion_analysis_empty_segments(self, contagion_module, sample_speaker_map):
    ...
    def test_contagion_analysis_single_speaker(self, contagion_module, sample_speaker_map):
