...
class TestTranscriptOutputAnalysis:
    ...
    def test_transcript_output_basic(
        self, transcript_output_module, sample_segments, sample_speaker_map
    ):
    ...
    def test_transcript_output_empty_segments(
        self, transcript_output_module, sample_speaker_map
    ):
        """Test transcript output with empty segments."""
        segments = []

        result = transcript_output_module.analyze(segments)
