...
class TestEntitySentimentAnalysis:
    ...
    @pytest.fixture
    def entity_sentiment_module(self):
    ...
    def sample_segments(self):
        ...
        return [
            {"speaker": "Alice", "speaker_db_id": 1, "text": "I love Python programming.", "start": 0.0, "end": 2.0},
            {"speaker": "Bob", "speaker_db_id": 2, "text": "Python is great for data science.", "start": 2.0, "end": 4.0},
            {"speaker": "Alice", "speaker_db_id": 1, "text": "I hate Java though.", "start": 4.0, "end": 6.0},
        ]
    ...
    def test_entity_sentiment_basic(self, mock_sentiment, mock_ner, entity_sentiment_module, sample_segments, sample_speaker_map):
        """Test basic entity sentiment analysis."""
        # Mock NER to return entities
        mock_ner.return_value = [
            {"text": "Python", "label": "ORG", "start": 10, "end": 16},
            {"text": "Java", "label": "ORG", "start": 10, "end": 14},
        ]
        ...
        assert "entity_sentiment" in result or "entities" in result or "summary" in result
    
    @patch('transcriptx.core.analysis.entity_sentiment.extract_named_entities')
    def test_entity_sentiment_with_ner_data(self, mock_ner, entity_sentiment_module, sample_segments, sample_speaker_map):
        ...
        mock_ner.return_value = ner_data["entities"]
        
        result = entity_sentiment_module.analyze(sample_segments, sample_speaker_map, ner_data=ner_data)
    ...
    @patch('transcriptx.core.analysis.entity_sentiment.extract_named_entities')
    @patch('transcriptx.core.analysis.entity_sentiment.score_sentiment')
    def test_entity_sentiment_speaker_aggregation(self, mock_sentiment, mock_ner, entity_sentiment_module, sample_segments, sample_speaker_map):
        ...
        assert "speaker_entity_sentiment" in result or "summary" in result or "speaker_mentions" in result
    
    @patch('transcriptx.core.analysis.entity_sentiment.extract_named_entities')
    def test_entity_sentiment_no_entities(self, mock_ner, entity_sentiment_module, sample_segments, sample_speaker_map):
    ...
    def test_entity_sentiment_empty_segments(self, entity_sentiment_module, sample_speaker_map):
    ...
    def test_entity_name_normalization(self, entity_sentiment_module):
