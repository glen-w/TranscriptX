...
class TestEntitySentimentAnalysis:
    ...
    def test_entity_sentiment_empty_segments(
        self, entity_sentiment_module: EntitySentimentAnalysis, sample_speaker_map: dict[str, str]
    ) -> None:
    ...
    def test_entity_name_normalization(self, entity_sentiment_module: EntitySentimentAnalysis) -> None:
