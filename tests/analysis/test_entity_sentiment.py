...
class TestEntitySentimentAnalysis:
    ...
    def test_entity_sentiment_basic(
        ...
        result = entity_sentiment_module.analyze(sample_segments)
    ...
    def test_entity_sentiment_with_ner_data(
        ...
        result = entity_sentiment_module.analyze(sample_segments, ner_data=ner_data)
    ...
    def test_entity_sentiment_empty_segments(
        ...
        result = entity_sentiment_module.analyze(segments)
