...
class TestDialogueActAnalysisModule:
    ...
    def test_acts_analysis_basic(
        ...
        result = acts_module.analyze(sample_segments)
    ...
    def test_acts_analysis_question(self, acts_module):
        ...
        result = acts_module.analyze(segments)

        # Should classify as question
        assert "segments" in result or "acts" in result

    def test_acts_analysis_statement(self, acts_module):
    ...
    def test_acts_analysis_greeting(self, acts_module):
    ...
    def test_acts_analysis_empty_segments(self, acts_module):
