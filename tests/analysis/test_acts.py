...
class TestDialogueActAnalysisModule:
    ...
    def sample_segments(self):
        ...
        return [
            {"speaker": "Alice", "speaker_db_id": 1, "text": "What time is it?", "start": 0.0, "end": 2.0},
            {"speaker": "Bob", "speaker_db_id": 2, "text": "It's 3 o'clock.", "start": 2.0, "end": 4.0},
            {"speaker": "Alice", "speaker_db_id": 1, "text": "Thank you!", "start": 4.0, "end": 5.0}
        ]
    ...
    def test_acts_analysis_basic(self, acts_module, sample_segments, sample_speaker_map):
        ...
        assert len(result.get("segments", result.get("acts", []))) == len(sample_segments)
    ...
    def test_acts_analysis_statement(self, acts_module, sample_speaker_map):
        ...
        segments = [
            {"speaker": "Alice", "speaker_db_id": 1, "text": "The weather is nice today.", "start": 0.0, "end": 2.0}
        ]
