"""
Tests for legacy semantic similarity analysis module.

This module tests basic similarity detection (legacy path).
"""
...
class TestSemanticSimilarityLegacyAnalysis:
    ...
    def sample_segments(self):
        ...
        return [
            ...
            {
                "speaker": "SPEAKER_01",
                "text": "I also love machine learning.",
                "start": 2.0,
                "end": 4.0,
            },
            {
    ...
    def test_semantic_similarity_basic(
        ...
        result = similarity_module.analyze(sample_segments)
    ...
    def test_semantic_similarity_repetition_detection(
        self,
        mock_analyzer_class,
        similarity_module,
        sample_segments,
        ...
        mock_analyzer = MagicMock()
        mock_analyzer.detect_repetitions.return_value = {
            "repetitions": [{"segment1": 0, "segment2": 1, "similarity": 0.95}],
    ...
    def test_semantic_similarity_empty_segments(
        self, similarity_module, sample_speaker_map
    ):
        ...
        with patch(
            ...
            result = similarity_module.analyze(segments)
    ...
    def test_semantic_similarity_speaker_aggregation(
        self,
        mock_analyzer_class,
        similarity_module,
        sample_segments,
