...
class TestUnderstandabilityAnalysis:
    ...
    def sample_segments(self):
        ...
        return [
            ...
            },
            {
                "speaker": "Alice",
                "speaker_db_id": 1,
                "text": "Complex sentences with multiple clauses are harder to understand.",
                "start": 4.0,
                "end": 6.0,
            },
        ]
    ...
    def test_understandability_basic(
        self,
        mock_compute,
        understandability_module,
        sample_segments,
        sample_speaker_map,
    ):
    ...
    def test_understandability_speaker_aggregation(
        self,
        mock_compute,
        understandability_module,
        sample_segments,
    ...
    def test_understandability_empty_segments(
        self, mock_compute, understandability_module, sample_speaker_map
    ):
    ...
    def test_understandability_metrics_computation(
        self, mock_compute, understandability_module, sample_speaker_map
    ):
