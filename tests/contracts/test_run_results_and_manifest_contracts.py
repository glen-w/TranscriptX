...
def test_golden_run_stats_produces_valid_manifest_and_run_results(
    ...
    assert summary.run_status in {None, "succeeded", "partial", "failed", "aborted"}
    ...
    if run_manifest_path.exists():
        ...
        assert run_manifest.get("manifest_type") == "run_manifest"
...
def test_single_pipeline_result_shape_contract(
    ...
    """Single-transcript pipeline result must contain required keys (contract)."""
    import transcriptx.core.pipeline.pipeline as pipeline_module
