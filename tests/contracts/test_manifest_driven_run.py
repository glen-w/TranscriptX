...
- RunManifestInput built from kwargs and from an on-disk manifest produce the same output structure.
"""
...
def test_cli_equivalent_and_manifest_run_same_structure(
    ...
    """Run once from RunManifestInput.from_cli_kwargs and once from a JSON manifest file; assert same output schema (not byte-identical run_id)."""
    fixture = _ensure_fixture()
