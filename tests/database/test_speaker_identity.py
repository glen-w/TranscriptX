...
class TestSpeakerIdentityService:
    ...
    def test_resolve_speaker_identity_new_speaker(self, service, transcript_file):
        ...
        session_data = [{"text": "Hello, this is a test.", "start": 0.0, "end": 3.0}]
    ...
    def test_resolve_speaker_identity_canonical_id(
        self, service, transcript_file, db_session
    ):
    ...
    def test_resolve_speaker_identity_logs_event(
        self, service, transcript_file, db_session
    ):
        ...
        events = (
            ...
            .filter_by(
                transcript_file_id=transcript_file.id, diarized_label="SPEAKER_01"
            )
            .all()
        )
    ...
    def test_resolve_speaker_identity_analysis_run_id(self, service, transcript_file):
        ...
        events = (
            service.session.query(SpeakerResolutionEvent)
