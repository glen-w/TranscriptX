...
class TestStatisticsService:
    ...
    def test_get_session_statistics(self, mock_path, mock_total_count, mock_get_modules, mock_file_service):
    ...
    def test_get_session_statistics_no_transcript(self, mock_file_service):
        ...
        with patch('transcriptx.web.services.statistics_service.get_analysis_modules', return_value=[]):
            with patch('transcriptx.web.services.statistics_service.get_total_module_count', return_value=18):
                with patch('transcriptx.web.services.statistics_service.Path') as mock_path:
                    session_dir = MagicMock()
    ...
    @patch('transcriptx.web.utils.list_available_sessions')
