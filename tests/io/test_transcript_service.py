...
class TestTranscriptService:
    ...
    def test_load_segments_caches_result(self, tmp_path):
        ...
        test_file.write_text(json.dumps({"segments": [{"speaker": "SPEAKER_01", "text": "Changed"}]}))
    ...
    def test_load_transcript_caches_result(self, tmp_path):
        ...
        # Modify file
        test_file.write_text(json.dumps({"segments": [], "metadata": {"version": "2.0"}}))
    ...
    def test_load_transcript_data_returns_complete_data(self, tmp_path):
        ...
        with patch('transcriptx.io.transcript_service.get_canonical_base_name') as mock_base, \
