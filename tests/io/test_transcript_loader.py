            ...
            "segments": [
                {
                    ...
                    "end": 2.0,
                    "words": [
                        {"word": "Hello", "speaker": "SPEAKER_00", "start": 0.0, "end": 1.0},
                        {"word": "world", "speaker": "SPEAKER_00", "start": 1.0, "end": 2.0},
                    ]
                }
            ]
        }
            ...
            "segments": [
                {
                    ...
                    "words": [
                        {"word": "Hello", "speaker": "SPEAKER_00", "start": 0.0, "end": 1.0},
                        {"word": "world", "speaker": "SPEAKER_01", "start": 1.0, "end": 2.0},
                    ]
                }
            ]
        }
...
class TestLoadTranscriptData:
    ...
    def test_loads_complete_data(self, tmp_path):
        ...
        with patch('transcriptx.io.transcript_service.get_transcript_service') as mock_service:
