...
class TestParallelExecutor:
    ...
    def test_executes_modules_in_parallel(self):
        ...
        mock_dag.nodes = {"module1": MagicMock(), "module2": MagicMock()}

        # Mock module execution
        def mock_execute(node, transcript_path):
            return {
                "module": node.name if hasattr(node, "name") else "module",
                "status": "success",
            }
        ...
        results = executor.execute_parallel(
            mock_dag, "test.json", ["module1", "module2"]
        )
    ...
    def test_handles_unknown_modules(self):
        ...
        results = executor.execute_parallel(mock_dag, "test.json", ["unknown_module"])
    ...
    def test_tracks_execution_order(self):
        ...
        results = executor.execute_parallel(
            mock_dag, "test.json", ["module1", "module2", "module3"]
        )
    ...
    def test_records_start_time(self):
        ...
        results = executor.execute_parallel(mock_dag, "test.json", [])
