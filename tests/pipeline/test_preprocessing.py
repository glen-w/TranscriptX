...
class TestPreprocessingService:
    ...
    def test_validate_transcript_success(self, preprocessing_service, temp_transcript_file):
        """Test successful transcript validation."""
        with patch('transcriptx.core.pipeline.preprocessing.validate_transcript_file') as mock_validate, \
             patch('transcriptx.core.pipeline.preprocessing.validate_output_directory') as mock_validate_dir:
    ...
    def test_prepare_transcript_data_success(self, preprocessing_service, temp_transcript_file, sample_transcript_data):
        """Test successful transcript data preparation."""
        data, base_name = preprocessing_service.prepare_transcript_data(str(temp_transcript_file))
        
        assert data == sample_transcript_data
        assert base_name == "test_transcript"
    
    def test_prepare_transcript_data_file_not_found(self, preprocessing_service, tmp_path):
    ...
    def test_prepare_transcript_data_invalid_json(self, preprocessing_service, tmp_path):
...
class TestPreprocessingModuleFunctions:
    ...
    def test_prepare_transcript_data_function(self, temp_transcript_file, sample_transcript_data):
    ...
    def test_prepare_transcript_data_with_nested_path(self, tmp_path, sample_transcript_data):
