...
def create_mock_workflow_result(success: bool = True, output_dir: str = "/tmp/test_output"):
    ...
    def _run(
        ...
        class Result:
            def __init__(self, typer_result):
                self.returncode = typer_result.exit_code if typer_result.exit_code is not None else 0
