...
class TestBaseDataExtractor:
    ...
    def extractor_with_required_fields(self):
        ...
        return ConcreteDataExtractor("test_module", required_fields=["test_field", "numeric_field"])
    ...
    def test_validate_data_missing_required_fields(self, extractor_with_required_fields):
        ...
        result = extractor_with_required_fields.validate_data(incomplete_data, "SPEAKER_00")
        assert result is False
        ...
        result = extractor_with_required_fields.validate_data(complete_data, "SPEAKER_00")
        assert result is True
    ...
    def test_validate_data_exception_handling(self, extractor):
        ...
        with patch.object(extractor, 'get_required_fields', side_effect=Exception("Test error")):
    ...
    def test_transform_data_error_handling(self, extractor):
        ...
        with patch.object(extractor, '_get_timestamp', side_effect=Exception("Test error")):
            raw_data = {"test": "value"}
            result = extractor.transform_data(raw_data, "SPEAKER_00")
...
class TestBaseExtractorAggregation:
    ...
    def test_aggregate_speaker_data_with_errors(self, extractor):
        ...
        speaker_data = {
            "SPEAKER_00": {
                "data": {"field": "value"},
                "quality_metrics": {"completeness": 1.0, "consistency": 1.0, "validity": 1.0}
            },
            "SPEAKER_01": {
