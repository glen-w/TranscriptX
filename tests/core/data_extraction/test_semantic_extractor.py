...
class TestSemanticDataExtractor:
    ...
    def sample_analysis_results(self):
        ...
        return {
            "repetitions": [
                {"segment1": 0, "segment2": 1, "similarity": 0.95, "speaker": "SPEAKER_00"}
            ],
            "similarity_scores": {
                "SPEAKER_00": [0.8, 0.9, 0.7]
            },
            "speaker_repetitions": {
                "SPEAKER_00": [
                    {"type": "exact", "similarity": 0.95}
                ]
            }
        }
    ...
    def test_extract_data_basic(self, extractor, sample_analysis_results):
        ...
        result = extractor.extract_data(sample_analysis_results, speaker_id="SPEAKER_00")
