...
class TestEntityDataExtractor:
            ...
            "segments": [
                {
                    ...
                    "entities": [
                        {"text": "Python", "type": "ORG", "sentiment": 0.8}
                    ]
                },
                {
                    "speaker": "SPEAKER_00",
                    ...
                    "entities": [
                        {"text": "Python", "type": "ORG", "sentiment": 0.9}
                    ]
                },
                {
                    "speaker": "SPEAKER_01",
                    ...
                    "entities": [
                        {"text": "Google", "type": "ORG", "sentiment": 0.5}
                    ]
                },
            ]
        }
    ...
    def test_extract_speaker_data_frequently_mentioned(self, extractor, sample_analysis_results):
