...
from transcriptx.core.data_extraction.interaction_extractor import InteractionDataExtractor
            ...
            "segments": [
                {
                    ...
                    "interactions": [
                        {"type": "interruption", "target_speaker": "SPEAKER_01", "duration": 0.5}
                    ]
                },
                {
                    "speaker": "SPEAKER_01",
                    "text": "Yes, I agree.",
                    "interactions": [
                        {"type": "response", "target_speaker": "SPEAKER_00", "duration": 1.0}
                    ]
                },
            ]
        }
