...
class TestSimilarityCalculator:
    ...
    def test_calculates_text_similarity_tfidf(self):
        ...
        similarity = calculator.calculate_text_similarity(
            "Hello world", "Hello world", method="tfidf"
        )
    ...
    def test_calculates_text_similarity_jaccard(self):
        ...
        similarity = calculator.calculate_text_similarity(
            "Hello world", "Hello world", method="jaccard"
        )
    ...
    def test_handles_unknown_method(self):
        ...
        similarity = calculator.calculate_text_similarity(
            "Hello", "World", method="unknown_method"
        )
...
class TestSimilarityCalculatorAdvanced:
    ...
    def test_all_similarity_methods(self, calculator):
        ...
        # Jaccard
        jaccard_sim = calculator.calculate_text_similarity(
        ...
        # Overlap
        overlap_sim = calculator.calculate_text_similarity(
            text1, text2, method="overlap"
        )
    ...
    def test_dictionary_similarity_methods(self, calculator):
        ...
        # Weighted
        weighted_sim = calculator.calculate_dict_similarity(
            dict1, dict2, method="weighted"
        )
        assert 0.0 <= weighted_sim <= 1.0

        # Jaccard (on keys)
        jaccard_sim = calculator.calculate_dict_similarity(
            dict1, dict2, method="jaccard"
        )
        assert 0.0 <= jaccard_sim <= 1.0
    ...
    def test_behavioral_similarity(self, calculator):
        ...
        similarity = calculator.calculate_behavioral_similarity(
