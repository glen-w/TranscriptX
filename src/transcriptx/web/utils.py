...
def load_transcript_by_session(session_name: str) -> Optional[Dict[str, Any]]:
    ...
    For analysis loading by path, use TranscriptService or io.transcript_loader.
...
# Backward-compat alias (tests and legacy code)
load_transcript_data = load_transcript_by_session
