...
**Production usage:** No other ``src/transcriptx`` modules import this package;
the active codebase relies on logging, Typer/Streamlit surfaces, and narrower
helpers elsewhere. This module remains for ``tests/utils/test_error_handling.py``
and optional experimentation (retry decorators, categorization helpers).
