...
# DB-free file commands (validate, canonicalize) — no database init
from .transcript_file_commands import register_transcript_file_commands

register_transcript_file_commands(app)
