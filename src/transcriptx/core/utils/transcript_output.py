...
def generate_human_friendly_transcript_from_file(
    ...
    Uses segment-based speaker identification. No speaker_map file is needed.
    ...
    # Run the analysis (no speaker_map needed - uses segment-based approach)
...
def generate_transcript_output_from_file(transcript_path: str) -> None:
    ...
    Uses segment-based speaker identification. No speaker_map is needed.
    ...
    segments, base_name, transcript_dir = load_transcript_data(transcript_path)
    # The transcript loader no longer returns mapping state; this output path
    # remains segment-driven and uses the segments directly.
    generate_human_friendly_transcript(segments, base_name, transcript_dir)
