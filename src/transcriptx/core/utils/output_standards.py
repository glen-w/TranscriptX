...
def create_standard_output_structure(
    ...
    *,
    ...
    if output_version:
        module_dir = transcript_dir_path / namespace / output_version
    else:
        module_dir = transcript_dir_path / namespace
...
def save_global_chart(*args: Any, **kwargs: Any) -> Path:
    raise NotImplementedError(
        "save_global_chart() has been removed. Use OutputService.save_chart() instead."
    )


def save_speaker_chart(*args: Any, **kwargs: Any) -> Path:
    raise NotImplementedError(
