...
class TranscriptXConfig:
    ...
    def _load_from_file(self, config_file: str):
        ...
        Note:
            ...
            Legacy "transcription" section is silently ignored if present.
        """
        ...
        try:
            ...
            # Silently ignore legacy "transcription" section (TranscriptX is analysis-only).
            if "transcription" in config_data:
                pass  # Backward compat: old configs with transcription section load without error.
