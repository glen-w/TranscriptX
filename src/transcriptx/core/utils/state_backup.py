...
from transcriptx.core.utils.paths import PROCESSING_STATE_FILE, STATE_BACKUP_DIR
...
def create_backup(state_file: Optional[Path] = None) -> Optional[Path]:
    ...
    backup_path = STATE_BACKUP_DIR / backup_filename
...
def rotate_backups() -> None:
    ...
    backups = sorted(
        STATE_BACKUP_DIR.glob("processing_state_*.json.backup"),
