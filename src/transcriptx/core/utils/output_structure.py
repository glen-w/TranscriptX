...
This module is not currently used by any analysis module. If you are adding
a new analysis module, use ensure_output_dirs from transcriptx.core.utils._path_core
(via common.create_module_output_structure). This builder may be adopted in a
future version for configurable output layouts.
"""
