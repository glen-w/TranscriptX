...
class IntegrationErrorHandler:
    ...
    def __init__(self):
        ...
        self.recovery_strategies = {
            ...
            "external_connection": self._handle_external_connection_error,
    ...
    def _classify_error(self, error: Exception) -> str:
        ...
        if any(
            ...
            keyword in error_message
            for keyword in ["connection", "database", "sql", "socket", "timeout"]
        ):
    ...
    def _handle_external_connection_error(
        self, error: Exception, context: str
    ) -> Dict[str, Any]:
        """
        Handle external connection errors (network, SQL drivers, etc.).
        ...
        Returns:
            Recovery result dictionary
        """
        self.logger.error(f"External connection error in {context}: {str(error)}")

        return {
            "success": False,
            "message": "Connection error requires manual intervention",
    ...
    def get_recommendations(self) -> List[str]:
        ...
        if most_common_error == "external_connection":
            recommendations.append(
                "Frequent connection issues — check network and service availability"
            )
            ...
            recommendations.append(
                "Frequent persistence errors - check file permissions and disk space"
            )
