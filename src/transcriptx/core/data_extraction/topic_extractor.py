...
topic modeling data from analysis results and transforms it for structured export.
"""
...
class TopicDataExtractor(BaseDataExtractor):
    ...
    def transform_data(
        ...
        """
        Transform topic data for structured export.

        Args:
            data: Raw extracted topic data

        Returns:
            Transformed data ready for downstream use
        """
