...
COMMON_SETTINGS_SCHEMA: tuple[CommonSettingField, ...] = (
    ...
    CommonSettingField(
        key="analysis.semantic_similarity_v2.enabled",
        group="Semantic Similarity v2 / General",
        label="Enable semantic similarity v2",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.mode",
        group="Semantic Similarity v2 / General",
        label="Semantic v2 mode",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.model_name",
        group="Semantic Similarity v2 / General",
        label="Semantic v2 embedding model",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.self_similarity_threshold",
        group="Semantic Similarity v2 / Thresholds",
        label="Self-similarity threshold",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.cross_speaker_similarity_threshold",
        group="Semantic Similarity v2 / Thresholds",
        label="Cross-speaker similarity threshold",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.self_time_window_seconds",
        group="Semantic Similarity v2 / Windows and limits",
        label="Self time window (seconds)",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.cross_speaker_time_window_seconds",
        group="Semantic Similarity v2 / Windows and limits",
        label="Cross-speaker time window (seconds)",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.max_candidate_pairs",
        group="Semantic Similarity v2 / Windows and limits",
        label="Max candidate pairs",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.top_k_per_segment",
        group="Semantic Similarity v2 / Windows and limits",
        label="Top-k candidates per segment",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.timeout_seconds",
        group="Semantic Similarity v2 / Windows and limits",
        label="Semantic v2 timeout (seconds)",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.batch_size",
        group="Semantic Similarity v2 / Performance",
        label="Semantic v2 embedding batch size",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.lru_size",
        group="Semantic Similarity v2 / Performance",
        label="Embedding LRU size",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.persist_embeddings",
        group="Semantic Similarity v2 / Performance",
        label="Persist embedding cache",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.min_text_length_words",
        group="Semantic Similarity v2 / Filtering",
        label="Minimum words per segment",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.use_lexical_prefilter",
        group="Semantic Similarity v2 / Filtering",
        label="Use lexical Jaccard prefilter",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.lexical_prefilter_min_jaccard",
        group="Semantic Similarity v2 / Filtering",
        label="Lexical prefilter minimum Jaccard",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_v2.strict_advanced_inputs",
        group="Semantic Similarity v2 / General",
...
PROFILE_TARGET_SUPPORT: dict[str, ProfileTargetSupport] = {
    ...
    "semantic_similarity_v2": ProfileTargetSupport(
        target_id="semantic_similarity_v2",
        profile_type="module",
        activation_key="analysis.active_semantic_similarity_v2_profile",
        activation_path=("analysis", "active_semantic_similarity_v2_profile"),
        config_path=("analysis", "semantic_similarity_v2"),
        scopes=("project", "run"),
    ),
...
PROFILE_EDIT_SUPPORT: dict[str, ProfileEditSupport] = {
    ...
    "semantic_similarity_v2": ProfileEditSupport(
        target_id="semantic_similarity_v2",
        guided_fields=(
            "enabled",
            "mode",
