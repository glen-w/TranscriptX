...
COMMON_SETTINGS_SCHEMA: tuple[CommonSettingField, ...] = (
    ...
    # Legacy flat semantics keys (pre nested analysis.semantic_similarity.*).
    # Prefer the Semantic Similarity groups below for new guided edits.
    CommonSettingField(
        key="analysis.semantic_similarity_threshold",
        group="Semantics (legacy)",
        label="Semantic similarity threshold (legacy flat)",
    ),
    CommonSettingField(
        key="analysis.cross_speaker_similarity_threshold",
        group="Semantics (legacy)",
        label="Cross-speaker similarity threshold (legacy flat)",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity_method",
        group="Semantics (legacy)",
        label="Semantic similarity method (legacy flat)",
    ),
    CommonSettingField(
    ...
    CommonSettingField(
        ...
        group="Semantic Similarity / General",
        label="Enable semantic similarity",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity.mode",
        group="Semantic Similarity / General",
        label="Semantic similarity mode",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity.model_name",
        group="Semantic Similarity / General",
        label="Semantic similarity embedding model",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity.self_similarity_threshold",
        group="Semantic Similarity / Thresholds",
    ...
    CommonSettingField(
        ...
        group="Semantic Similarity / Windows and limits",
    ...
    CommonSettingField(
        ...
        group="Semantic Similarity / Windows and limits",
        label="Semantic similarity timeout (seconds)",
    ),
    CommonSettingField(
        key="analysis.semantic_similarity.batch_size",
        group="Semantic Similarity / Performance",
        label="Semantic similarity embedding batch size",
    ),
    CommonSettingField(
    ...
    CommonSettingField(
        ...
        group="Semantic Similarity / Filtering",
    ...
    CommonSettingField(
        ...
        group="Semantic Similarity / Motifs (B14)",
...
PROFILE_TARGET_SUPPORT: dict[str, ProfileTargetSupport] = {
    ...
    "semantic_similarity": ProfileTargetSupport(
        ...
        # Disk ProfileManager profiles under profiles/semantic_similarity/.
        # Separate in-config mapping: analysis.semantic_similarity_profiles
        # (fast/balanced/deep) — see docs/runtime/settings.md.
