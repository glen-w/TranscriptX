...
from .models.llm_action_items import LLMActionItemsSettingsModel
from .models.llm_custom_qa import LLMCustomQASettingsModel
from .models.ui_presets import AnalysisUiPresetsModel
...
PYDANTIC_REGISTRY_PILOTS: tuple[PydanticPilotSpec, ...] = (
    ...
    PydanticPilotSpec(
        pilot_id="llm_action_items_settings",
        model=LLMActionItemsSettingsModel,
        dotpath_prefix="analysis.llm_action_items",
        category="analysis",
        dataclass_type=LLMActionItemsConfig,
    ),
    PydanticPilotSpec(
        pilot_id="llm_custom_qa_settings",
        model=LLMCustomQASettingsModel,
        dotpath_prefix="analysis.llm_custom_qa",
        category="analysis",
        dataclass_type=LLMCustomQAConfig,
    ),
    PydanticPilotSpec(
        pilot_id="ui_presets_settings",
        model=AnalysisUiPresetsModel,
        dotpath_prefix="analysis.ui_presets",
        category="analysis",
        dataclass_type=AnalysisUiPresetsConfig,
    ),
    PydanticPilotSpec(
        pilot_id="workflow",
    ...
    PydanticPilotSpec(
        pilot_id="transcript_quality",
        model=TranscriptQualitySettingsModel,
    ...
    PydanticPilotSpec(
        pilot_id="keyphrases",
        model=KeyphrasesSettingsModel,
        dotpath_prefix="analysis.keyphrases",
        category="analysis",
        dataclass_type=KeyphrasesConfig,
    ),
    PydanticPilotSpec(
        pilot_id="politeness",
