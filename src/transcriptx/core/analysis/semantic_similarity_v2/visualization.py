"""Visualization utilities for semantic_similarity_v2 outputs."""
...
MODULE_ID = "semantic_similarity_v2"
...
def create_visualizations_v2(
    ...
    """Create legacy-equivalent charts for semantic_similarity_v2 results."""
    ...
    try:
        ...
        if speaker_similarity:
            ...
            _record_saved_path(
                output_service.save_chart(
                    _bar_spec(
                        viz_id="semantic_similarity_v2.speaker_similarity.global",
        ...
        if classification_counts:
            ...
            _record_saved_path(
                output_service.save_chart(
                    _bar_spec(
                        viz_id="semantic_similarity_v2.classification.global",
                        name="classification",
        ...
        if similarities:
            ...
            _record_saved_path(
                output_service.save_chart(
                    _bar_spec(
                        viz_id="semantic_similarity_v2.similarity_distribution.global",
